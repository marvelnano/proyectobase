    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#!">Alissa Bazar</a>
        ...
        <section class="py-5">
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="http://localhost:83/proyectobase/backend/<?php echo $detalleProd['imagen'];?>" alt="..." /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">SKU: <?php echo $detalleProd['codigo_sku'];?></div>
                        <h1 class="display-5 fw-bolder"><?php echo $detalleProd['titulo'];?></h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">$<?php echo $detalleProd['precio_venta'];?></span>
                            <span>$<?php echo $detalleProd['precio_costo'];?></span>
                        </div>
